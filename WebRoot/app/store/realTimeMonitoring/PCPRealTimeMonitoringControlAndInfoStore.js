Ext.define('AP.store.realTimeMonitoring.PCPRealTimeMonitoringControlAndInfoStore', {
    ...
    listeners: {
        load: function (store, record, f, op, o) {
        	...
        	var deviceAuxiliaryInfoGridPanel=Ext.getCmp("PCPRealTimeMonitoringAuxiliaryDeviceInfoDataGridPanel_Id");
    		if(!isNotVal(deviceAuxiliaryInfoGridPanel)){
    			deviceAuxiliaryInfoGridPanel=Ext.create('Ext.grid.Panel', {
    				id:'PCPRealTimeMonitoringAuxiliaryDeviceInfoDataGridPanel_Id',
    			...
    			Ext.getCmp("PCPRealTimeMonitoringRightAuxiliaryDeviceInfoPanel").add(deviceAuxiliaryInfoGridPanel);
    		}else{
    		...
    		if(total>0&&Ext.getCmp("PCPRealTimeMonitoringRightTabPanel").getActiveTab().id!="PCPRealTimeMonitoringRightControlPanel"){
