    ...
    initComponent: function () {
    	...
    	Ext.apply(this, {
    		...
    		tbar: [{
            	...
            	xtype: 'numberfield',
            	id: 'PipelineEnumValueAlarmQueryStartTime_Hour_Id',
                fieldLabel: '时',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'PipelineEnumValueAlarmQueryStartTime_Minute_Id',
                fieldLabel: '分',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'PipelineEnumValueAlarmQueryStartTime_Second_Id',
                fieldLabel: '秒',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'PipelineEnumValueAlarmQueryEndTime_Hour_Id',
                fieldLabel: '时',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'PipelineEnumValueAlarmQueryEndTime_Minute_Id',
                fieldLabel: '分',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'PipelineEnumValueAlarmQueryEndTime_Second_Id',
                fieldLabel: '秒',
                labelWidth: 15,
                width: 60,
                minValue: 0,
                ...
                handler: function () {
                	...
                	if(!r.test(startTime_Hour)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>小时为0~23之间的整数。");
                		Ext.getCmp('PipelineEnumValueAlarmQueryStartTime_Hour_Id').focus(true, 100);
                		return;
                	}
                	var startTime_Minute=Ext.getCmp('PipelineEnumValueAlarmQueryStartTime_Minute_Id').getValue();
                	if(!r2.test(startTime_Minute)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>分钟为0~59之间的整数。");
                		Ext.getCmp('PipelineEnumValueAlarmQueryStartTime_Minute_Id').focus(true, 100);
                		return;
                	}
                	var startTime_Second=Ext.getCmp('PipelineEnumValueAlarmQueryStartTime_Second_Id').getValue();
                	if(!r2.test(startTime_Second)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>秒为0~59之间的整数。");
                		Ext.getCmp('PipelineEnumValueAlarmQueryStartTime_Second_Id').focus(true, 100);
                		return;
                	}
                	...
                	if(!r.test(endTime_Hour)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>小时为0~23之间的整数。");
                		Ext.getCmp('PipelineEnumValueAlarmQueryEndTime_Hour_Id').focus(true, 100);
                		return;
                	}
                	var endTime_Minute=Ext.getCmp('PipelineEnumValueAlarmQueryEndTime_Minute_Id').getValue();
                	if(!r2.test(endTime_Minute)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>分钟为0~59之间的整数。");
                		Ext.getCmp('PipelineEnumValueAlarmQueryEndTime_Minute_Id').focus(true, 100);
                		return;
                	}
                	var endTime_Second=Ext.getCmp('PipelineEnumValueAlarmQueryEndTime_Second_Id').getValue();
                	if(!r2.test(endTime_Second)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>秒为0~59之间的整数。");
                		Ext.getCmp('PipelineEnumValueAlarmQueryEndTime_Second_Id').focus(true, 100);
                		return;
                	}
                ...
                handler: function (v, o) {
                	...
                	var orgId = Ext.getCmp('leftOrg_Id').getValue();
                	var deviceType=1;
                	var deviceId  = Ext.getCmp("PipelineEnumValueAlarmOverviewGridPanel_Id").getSelectionModel().getSelection()[0].data.id;
                    ...
                    var endDate=Ext.getCmp('PipelineEnumValueAlarmQueryEndDate_Id').rawValue;
               	 	...
               	 	var fileName='管设备'+deviceName+'枚举量报警数据';
               	 	var title='管设备'+deviceName+'枚举量报警数据';
