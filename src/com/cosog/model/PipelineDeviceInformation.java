...
/**
 *  <p>描述：管设备信息 实体类  tbl_pipelinedevice</p>
 *  
 * @author zhao  2021-12-17
 *
 */
@Entity
@Table(name = "tbl_pipelinedevice")
public class PipelineDeviceInformation implements java.io.Serializable {
	/**
	 * 
	 */
	...
	// Constructors
	/** default constructor */
	public PipelineDeviceInformation() {
	}

	/** full constructor */
	public PipelineDeviceInformation(Integer id, Integer orgId, String wellName, Integer deviceType,
